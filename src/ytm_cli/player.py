...
def _create_cookies_file_from_headers(headers_file: Path, cookies_file: Path) -> bool:
    """Create a Netscape cookies.txt from headers.json cookie string.
    ...
    try:
        ...
        # Parse cookies and write in Netscape format
        ...
        for part in cookie_str.split("; "):
            if "=" in part:
                ...
                # Use .youtube.com domain for all cookies
...
class Player:
    ...
    def play(self, video_id: str) -> float:
        ...
        # Generate cookies.txt from headers.json if needed
        if not cookies_file.exists() and headers_file.exists():
            _create_cookies_file_from_headers(headers_file, cookies_file)
        ...
        cmd = [
            ...
            # Use browser cookies directly - more reliable than exported cookies
